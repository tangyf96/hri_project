...
void people_callback(const geometry_msgs::TransformStampedPtr& msg)
    {
...
int main(int argc, char **argv)
{
  ...
  */
  ...
  ros::Subscriber sub = n.subscribe("vicon/Helmet_1/Helmet_1", 1, people_callback); 
  ...
  { 
    ...
    ROS_INFO("person.position.x %f",person.position.x);
    //ROS_INFO("1");
    ROS_INFO("person.position.y %f",person.position.y);
